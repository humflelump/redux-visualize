...
export const concatination = graph.add(createSelector, 'concat sel', __filename)(text1, text2, concat);

function convertConcatToNumber(concatination) {
    return +concatination;
}
export const concatAsNumber = graph.add(createSelector)(concatination, convertConcatToNumber);
...
export const computation = graph.add(createAsyncSelector, null, __filename)({
    ...
    onResolve: () => window.store.dispatch({type: 'empty'}),
